(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.HAYAML = factory());
	...
	var html2json$1 = {exports: {}};

	var htmlparser$1 = {exports: {}};
	 ...
	 *
	 */
	var htmlparser = htmlparser$1.exports;
	...
	function requireHtmlparser () {
		...
		(function (module) {
			...
			})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : htmlparser, function () {

				// === ORIGINAL HTML5 Parser code starts here ===
					...
					HTMLParser(html, {
						start: function (tagName, attrs, unary) {
							if (one[tagName]) {
								...
								if (!unary) elems.push(curParentNode);
								return;
							}
						...
						chars: function (text) { curParentNode.appendChild(doc.createTextNode(text)); },
						comment: function (text) { }
					});
		...
		return htmlparser$1.exports;
	}

	var html2json = html2json$1.exports;

	var hasRequiredHtml2json;

	function requireHtml2json () {
		if (hasRequiredHtml2json) return html2json$1.exports;
		hasRequiredHtml2json = 1;
		(function (module) {
			(function(global) {
		...
		return html2json$1.exports;
	}

	var hayaml$1;
	var hasRequiredHayaml;

	function requireHayaml () {
		if (hasRequiredHayaml) return hayaml$1;
		hasRequiredHayaml = 1;
		const yaml = requireJsYaml();
		const { html2json, json2html } = requireHtml2json();
	...
	var hayamlExports = requireHayaml();
	var hayaml = /*@__PURE__*/getDefaultExportFromCjs(hayamlExports);
